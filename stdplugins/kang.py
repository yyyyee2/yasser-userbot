...
async def _(event):
    ...
    packname = f"My UserBot Kang"
    packshortname = f"yasser_userbot{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"My User Bot_AnimatedStickers"
        packshortname = f"yasser_userbot_Animated{userid}"  # format: Uni_Borg_userid
