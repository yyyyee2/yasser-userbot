...
async def _(event):
    ...
    packname = f"{first}'s Kang"
    packshortname = f"{first}Kang_{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"{first}'s_AnimatedStickers"
        packshortname = f"{first}_Animated_{userid}"  # format: Uni_Borg_userid
